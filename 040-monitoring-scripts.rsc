/system script
add dont-require-permissions=yes name=monWan1Status owner=admin policy=\
    ...
    \n\t\r\
    \n\t:local wanInterfaceName;\r\
    \n\t:local srcAdress;\r\
    \n\t:local routeDistance;\r\
    \n\t:local badRouteDistance;\r\
    \n\r\
    \n\t:set wanInterfaceName \$interfaceName1;\r\
    ...
    \n\r\
    \n\t:local wanTest1 ([/tool/netwatch/get [find where host=\$test1Address and src-address=\$srcAdress] status]);\r\
    \n\t:local wanTest2 ([/tool/netwatch/get [find where host=\$test2Address and src-address=\$srcAdress] status]);\r\
    \n\t:local wanTest3 ([/tool/netwatch/get [find where host=\$test3Address and src-address=\$srcAdress] status]);\r\
    ...
    \n\t\t:log info (\"There is internet connectivity on Interface \" . \$wanInterfaceName .\", Nothing should be done\
    \");\r\
    \n                             /ip/dhcp-client/set [find where interface=\"\$wanInterfaceName\" and default-route-d\
    istance>100] default-route-distance=\$routeDistance; \r\
    \n\t} else={\r\
    \n\t\t:log info (\"There is no internet connectivity on Interface \". \$wanInterfaceName .\", The Metric of the int\
    erface should be changed\");\r\
    \n                            /ip/dhcp-client/set [find where interface=\"\$wanInterfaceName\" and default-route-di\
    stance<100] default-route-distance=\$badRouteDistance  ;\r\
    \n\t}\r\
    \n}"
add dont-require-permissions=yes name=monWan2Status owner=admin policy=\
    ftp,reboot,read,write,policy,test,password,sniff,sensitive,romon source="{\r\
    \n\t:local interfaceName1 \"ether1\";\r\
    \n\t:local intrfaceSrcAdress1 \"10.1.1.1\"\r\
    \n\t:local routeDistance1 10;\r\
    ...
    \n\t:local badRouteDistance;\r\
    \n\r\
    \n\t:set wanInterfaceName \$interfaceName2;\r\
    ...
    \n\t}\r\
    \n}"
add dont-require-permissions=yes name=monWan3Status owner=admin policy=\
    ftp,reboot,read,write,policy,test,password,sniff,sensitive,romon source="{\r\
    \n\t:local interfaceName1 \"ether1\";\r\
    \n\t:local intrfaceSrcAdress1 \"10.1.1.1\"\r\
    \n\t:local routeDistance1 10;\r\
    ...
    \n\t:local badRouteDistance;\r\
    \n\r\
    \n\t:set wanInterfaceName \$interfaceName3;\r\
    ...
    \n\t}\r\
    \n}"
add dont-require-permissions=yes name=monWan4Status owner=admin policy=\
    ftp,reboot,read,write,policy,test,password,sniff,sensitive,romon source="{\r\
    \n\t:local interfaceName1 \"ether1\";\r\
    \n\t:local intrfaceSrcAdress1 \"10.1.1.1\"\r\
    \n\t:local routeDistance1 10;\r\
    ...
    \n\t:local badRouteDistance;\r\
    \n\r\
    \n\t:set wanInterfaceName \$interfaceName4;\r\
